...
{{--    @include('admin.modules.system-settings.routingSettingBasic')--}}
    <li class="breadcrumb-item active">     كل الإضافات </li>
@endsection
    ...
    <script>
        ...
        $(document).on('click', '.delete', function () {
            ...
            swal({
                ...
                var url = '{{ route("add-ons.destroy", ":id") }}';
                url = url.replace(':id', id);
                console.log(url);
                $.ajax({
                    url: url,
        ...
        $(document).on('click', '.status', function () {
            ...
            swal({
                ...
                var url = '{{ route("add-ons.changeStatus", ":id") }}'
                url = url.replace(':id', id);
                console.log(url);
                $.ajax({
                    url: url,
