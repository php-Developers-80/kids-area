...
@section('content')
    ...
    <section class="items-add-page my-3 py-4" style="background-color: white;">
        ...
        <form action="{{route('userPermissions.update',$user->id)}}" method="post" id="Form">
            @csrf
            @method("put")
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-12 mb-4 " style="direction: ltr;">
                            ...
                            <div class="mb-4">
                                ...
                                <input  {{in_array($parent_permission->id,$userPermissions)?'checked':''}} type="checkbox" id="md_checkbox_all-{{$parent_permission->id}}" name="permissions[]" value="{{$parent_permission->id}}"
                                    ...
                                    <div class="row mt-4 border py-2 row permissions-row d-flex align-items-center justify-content-end">
                                        ...
                                        <div class="col-12 mb-4 " style="direction: ltr;">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input {{in_array($permission->id,$userPermissions)?'checked':''}} type="checkbox" id="md_checkbox_all-{{$permission->id}}" name="permissions[]" value="{{$permission->id}}"
                                                ...
                                                <div class="border py-2 row permissions-row d-flex align-items-center justify-content-end">
                                                    ...
                                                    @foreach($sub_permissions as $sub_permission)
                                                        <div class="my-2  col-lg-3 col-md-4 col-sm-6 ">
                                                            <input {{in_array($sub_permission->id,$userPermissions)?'checked':''}} type="checkbox" id="md_checkbox_all-{{$sub_permission->id}}" name="permissions[]" value="{{$sub_permission->id}}"
